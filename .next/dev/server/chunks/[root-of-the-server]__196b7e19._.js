...
async function POST(req) {
    ...
    return new Promise((resolve, reject)=>{
        form.parse(req, async (err, fields, files)=>{
            if (err) return resolve(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: err.message
            }, {
                status: 500
            }));
            ...
            if (files.image) {
                ...
                imageUrl = `/uploads/${__TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].basename(file.filepath)}`;
            }
            if (files.video) {
                const file = Array.isArray(files.video) ? files.video[0] : files.video;
                videoUrl = `/uploads/${__TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].basename(file.filepath)}`;
            }
            try {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__196b7e19._.js.map