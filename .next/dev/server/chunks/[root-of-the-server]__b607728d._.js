...
"[project]/app/api/friends/accept/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getUserFromCookie"])();
        if (!user) {
        ...
        const friendRequest = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].friendRequest.findUnique({
            where: {
                id: requestId
            }
        });
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].friendRequest.update({
            where: {
                id: requestId
            },
            data: {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].friend.create({
            data: {
                userId: userA,
                friendId: userB
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b607728d._.js.map