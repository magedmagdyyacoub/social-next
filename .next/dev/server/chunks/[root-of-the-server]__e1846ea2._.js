...
"[project]/app/api/comments/[id]/like/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req, context) {
    try {
        ...
        const comment = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].comment.findUnique({
            where: {
                id: commentId
            }
        });
        if (!comment) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Comment not found"
        }, {
            status: 404
        });
        // check if user already liked the comment
        const existingLike = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].commentLike.findUnique({
            where: {
                commentId_userId: {
                    commentId,
                    userId: user.id
        ...
        if (existingLike) {
            // unlike
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].commentLike.delete({
                where: {
                    commentId_userId: {
                        commentId,
                        userId: user.id
            ...
            // like
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].commentLike.create({
                data: {
                    commentId,
                    userId: user.id
                }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e1846ea2._.js.map