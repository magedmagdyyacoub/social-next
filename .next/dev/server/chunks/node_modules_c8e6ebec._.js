...
var COLON = ("TURBOPACK compile-time truthy", 1) ? ';' : "TURBOPACK unreachable";
...
"[project]/node_modules/fluent-ffmpeg/lib/utils.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

/*jshint node:true*/ var exec = __turbopack_context__.r("[externals]/child_process [external] (child_process, cjs)").exec;
var isWindows = __turbopack_context__.r("[externals]/os [external] (os, cjs)").platform().match(/win(32|64)/);
var which = __turbopack_context__.r("[project]/node_modules/which/which.js [app-route] (ecmascript)");
var nlRegexp = /\r\n|\r|\n/g;
var streamRegexp = /^\[?(.*?)\]?$/;
...
"[project]/node_modules/fluent-ffmpeg/lib/options/inputs.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

/*jshint node:true*/ var utils = __turbopack_context__.r("[project]/node_modules/fluent-ffmpeg/lib/utils.js [app-route] (ecmascript)");
/*
...
"[project]/node_modules/fluent-ffmpeg/lib/options/audio.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/fluent-ffmpeg/lib/options/video.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/fluent-ffmpeg/lib/options/videosize.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/fluent-ffmpeg/lib/options/output.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/fluent-ffmpeg/lib/options/custom.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/fluent-ffmpeg/lib/options/misc.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

/*jshint node:true*/ var path = __turbopack_context__.r("[externals]/path [external] (path, cjs)");
/*
   ...
   */ proto.usingPreset = proto.preset = function(preset) {
        if (typeof preset === 'function') {
            ...
            try {
                ...
                if (typeof module1.load === 'function') {
                    module1.load(this);
                } else {
...
"[project]/node_modules/async/lib/async.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

/*global setImmediate: false, setTimeout: false, console: false */ (function() {
    var async = {};
    ...
    async.auto = function(tasks, callback) {
        ...
        _each(keys, function(k) {
            var task = tasks[k] instanceof Function ? [
                tasks[k]
            ] : tasks[k];
...
"[project]/node_modules/fluent-ffmpeg/lib/processor.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

/*jshint node:true*/ var spawn = __turbopack_context__.r("[externals]/child_process [external] (child_process, cjs)").spawn;
var path = __turbopack_context__.r("[externals]/path [external] (path, cjs)");
var fs = __turbopack_context__.r("[externals]/fs [external] (fs, cjs)");
var async = __turbopack_context__.r("[project]/node_modules/async/lib/async.js [app-route] (ecmascript)");
var utils = __turbopack_context__.r("[project]/node_modules/fluent-ffmpeg/lib/utils.js [app-route] (ecmascript)");
/*
 *! Processor methods
 */ /**
...
module.exports = function(proto) {
   ...
   */ proto._getArguments = function() {
        ...
        this._inputs.reduce(function(args, input) {
            ...
            return args.concat(input.options.get(), [
                '-i',
                source
            ]);
        }, []), // Global options
        ...
        this._outputs.reduce(function(args, output) {
            ...
            return args.concat(output.audio.get(), audioFilters.length ? [
                '-filter:a',
                audioFilters.join(',')
            ] : [], output.video.get(), videoFilters.length ? [
                '-filter:v',
                videoFilters.join(',')
            ] : [], output.options.get(), outputArg);
        }, []));
    };
    /**
...
"[project]/node_modules/fluent-ffmpeg/lib/capabilities.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

/*jshint node:true*/ var fs = __turbopack_context__.r("[externals]/fs [external] (fs, cjs)");
var path = __turbopack_context__.r("[externals]/path [external] (path, cjs)");
var async = __turbopack_context__.r("[project]/node_modules/async/lib/async.js [app-route] (ecmascript)");
var utils = __turbopack_context__.r("[project]/node_modules/fluent-ffmpeg/lib/utils.js [app-route] (ecmascript)");
/*
...
"[project]/node_modules/fluent-ffmpeg/lib/ffprobe.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

/*jshint node:true, laxcomma:true*/ var spawn = __turbopack_context__.r("[externals]/child_process [external] (child_process, cjs)").spawn;
        ...
        this._getFfprobePath(function(err, path) {
            ...
            function handleExit(err) {
                ...
                if (processExited && stdoutClosed && stderrClosed) {
                    ...
                    [
                        data.format
                    ].concat(data.streams).forEach(function(target) {
                        if (target) {
...
"[project]/node_modules/fluent-ffmpeg/lib/recipes.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/fluent-ffmpeg/lib/fluent-ffmpeg.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 */ function FfmpegCommand(input, options) {
    ...
    options.presets = options.presets || options.preset || path.join(("TURBOPACK compile-time value", "/ROOT/node_modules/fluent-ffmpeg/lib"), 'presets');
...
/* Add methods from options submodules */ __turbopack_context__.r("[project]/node_modules/fluent-ffmpeg/lib/options/inputs.js [app-route] (ecmascript)")(FfmpegCommand.prototype);
__turbopack_context__.r("[project]/node_modules/fluent-ffmpeg/lib/options/audio.js [app-route] (ecmascript)")(FfmpegCommand.prototype);
__turbopack_context__.r("[project]/node_modules/fluent-ffmpeg/lib/options/video.js [app-route] (ecmascript)")(FfmpegCommand.prototype);
__turbopack_context__.r("[project]/node_modules/fluent-ffmpeg/lib/options/videosize.js [app-route] (ecmascript)")(FfmpegCommand.prototype);
__turbopack_context__.r("[project]/node_modules/fluent-ffmpeg/lib/options/output.js [app-route] (ecmascript)")(FfmpegCommand.prototype);
__turbopack_context__.r("[project]/node_modules/fluent-ffmpeg/lib/options/custom.js [app-route] (ecmascript)")(FfmpegCommand.prototype);
__turbopack_context__.r("[project]/node_modules/fluent-ffmpeg/lib/options/misc.js [app-route] (ecmascript)")(FfmpegCommand.prototype);
/* Add processor methods */ __turbopack_context__.r("[project]/node_modules/fluent-ffmpeg/lib/processor.js [app-route] (ecmascript)")(FfmpegCommand.prototype);
/* Add capabilities methods */ __turbopack_context__.r("[project]/node_modules/fluent-ffmpeg/lib/capabilities.js [app-route] (ecmascript)")(FfmpegCommand.prototype);
...
/* Add ffprobe methods */ __turbopack_context__.r("[project]/node_modules/fluent-ffmpeg/lib/ffprobe.js [app-route] (ecmascript)")(FfmpegCommand.prototype);
FfmpegCommand.ffprobe = function(file) {
    var instance = new FfmpegCommand(file);
    instance.ffprobe.apply(instance, Array.prototype.slice.call(arguments, 1));
};
/* Add processing recipes */ __turbopack_context__.r("[project]/node_modules/fluent-ffmpeg/lib/recipes.js [app-route] (ecmascript)")(FfmpegCommand.prototype);
}),
"[project]/node_modules/fluent-ffmpeg/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

module.exports = __turbopack_context__.r("[project]/node_modules/fluent-ffmpeg/lib/fluent-ffmpeg.js [app-route] (ecmascript)");
}),
"[project]/node_modules/ffmpeg-static/package.json (json)", ((__turbopack_context__) => {

__turbopack_context__.v({"name":"ffmpeg-static","version":"5.3.0","description":"ffmpeg binaries for macOS, Linux and Windows","scripts":{"install":"node install.js","prepublishOnly":"npm run install"},"ffmpeg-static":{"binary-path-env-var":"FFMPEG_BIN","binary-release-tag-env-var":"FFMPEG_BINARY_RELEASE","binary-release-tag":"b6.1.1","binaries-url-env-var":"FFMPEG_BINARIES_URL","executable-base-name":"ffmpeg"},"repository":{"type":"git","url":"https://github.com/eugeneware/ffmpeg-static"},"keywords":["ffmpeg","static","binary","binaries","mac","linux","windows"],"authors":["Eugene Ware <eugene@noblesamurai.com>","Jannis R <mail@jannisr.de>"],"contributors":["Thefrank (https://github.com/Thefrank)","Emil Sivervik <emil@sivervik.com>"],"license":"GPL-3.0-or-later","bugs":{"url":"https://github.com/eugeneware/ffmpeg-static/issues"},"engines":{"node":">=16"},"dependencies":{"@derhuerst/http-basic":"^8.2.0","env-paths":"^2.2.0","https-proxy-agent":"^5.0.0","progress":"^2.0.3"},"devDependencies":{"any-shell-escape":"^0.1.1"},"main":"index.js","files":["index.js","install.js","example.js","types"],"types":"types/index.d.ts"});}),
"[project]/node_modules/ffmpeg-static/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const pkg = __turbopack_context__.r("[project]/node_modules/ffmpeg-static/package.json (json)");
...
"[project]/node_modules/next/dist/esm/build/templates/app-route.js { INNER_APP_ROUTE => \"[project]/app/api/reels/upload/route.js [app-route] (ecmascript)\" } [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$response$2d$cache$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/next/dist/esm/server/response-cache/index.js [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$response$2d$cache$2f$types$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/esm/server/response-cache/types.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$reels$2f$upload$2f$route$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/api/reels/upload/route.js [app-route] (ecmascript)");
;
;
;
;
...
const routeModule = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$route$2d$modules$2f$app$2d$route$2f$module$2e$compiled$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppRouteRouteModule"]({
    ...
    nextConfigOutput,
    userland: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$reels$2f$upload$2f$route$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__
});
...
//# sourceMappingURL=node_modules_c8e6ebec._.js.map