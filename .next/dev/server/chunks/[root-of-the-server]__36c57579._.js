...
"[project]/app/api/posts/[id]/interact/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req, context) {
    try {
        ...
        // Like/unlike post
        if (data.type === "like") {
            const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].like.findUnique({
                where: {
                    postId_userId: {
                        postId: id,
                        userId: user.id
            ...
            if (existing) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].like.delete({
                    where: {
                        postId_userId: {
                            postId: id,
                            userId: user.id
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].like.create({
                    data: {
                        postId: id,
                        userId: user.id
                    }
            ...
            const comment = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].comment.create({
                data: commentData
            });
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                comment
...
//# sourceMappingURL=%5Broot-of-the-server%5D__36c57579._.js.map