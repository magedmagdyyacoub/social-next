...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$formidable$2d$serverless$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/formidable-serverless/lib/index.js [app-route] (ecmascript)");
...
if (!__TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].existsSync(uploadDir)) __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].mkdirSync(uploadDir, {
    recursive: true
});
...
async function PUT(req, context) {
    ...
    const form = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$formidable$2d$serverless$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])({
        multiples: false,
        keepExtensions: true,
        uploadDir
    });
    try {
        ...
        const imageUrl = imageFile ? `/uploads/${__TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].basename(imageFile.filepath)}` : post.image;
        const videoUrl = videoFile ? `/uploads/${__TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].basename(videoFile.filepath)}` : post.video;
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].post.update({
            where: {
                id: params.id
            },
            data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2cf186c3._.js.map