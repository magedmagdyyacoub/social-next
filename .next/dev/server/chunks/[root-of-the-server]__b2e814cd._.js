...
"[project]/app/api/friends/add/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        if (!friendId) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Friend ID required"
        }, {
            status: 400
        });
        // تحقق إذا الطلب موجود بالفعل
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].friendRequest.findFirst({
            where: {
                fromId: user.id,
                toId: friendId
            }
        ...
        const request = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].friendRequest.create({
            data: {
                fromId: user.id,
                toId: friendId,
                status: "PENDING"
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b2e814cd._.js.map