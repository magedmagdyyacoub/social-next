...
"[project]/app/api/messages/[friendId]/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, { params }) {
    try {
        ...
        // لو فيه afterId → نجيب الرسائل الجديدة فقط
        if (afterId) {
            const lastMessage = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].message.findUnique({
                where: {
                    id: afterId
                }
            });
        ...
        const messages = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].message.findMany({
            where,
            orderBy: {
                createdAt: "asc"
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0be45ab5._.js.map