...
"[project]/app/api/messages/get-chat/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        let chat = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].chat.findFirst({
            where: {
                users: {
                    every: {
                        userId: {
        ...
        if (!chat) {
            chat = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].chat.create({
                data: {
                    users: {
                        create: [
                            {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__248a61dd._.js.map